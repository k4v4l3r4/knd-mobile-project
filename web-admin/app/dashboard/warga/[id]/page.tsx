...
export default function WargaDetailPage() {
  ...
  const handleEditFamilyMember = (member: Warga) => {
    ...
    setFormData({
      ...
      marital_status: member.marital_status || 'Belum Kawin',
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex space-x-2">
            <button 
                onClick={() => handleEditFamilyMember(warga)}
            ...
            <div className="p-6 border-b border-slate-100 flex justify-between items-center sticky top-0 bg-white/95 backdrop-blur z-10">
              <div>
                  <h2 className="text-xl font-bold text-slate-800">
                    {modalMode === 'add' ? 'Tambah Anggota Keluarga' : (editingMember?.status_in_family === 'KEPALA_KELUARGA' ? 'Edit Kepala Keluarga' : 'Edit Anggota Keluarga')}
                  </h2>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      {editingMember?.status_in_family === 'KEPALA_KELUARGA' && (
                ...
                >
                  {saving ? (
                    ...
                    <>
                      ...
                      {editingMember?.status_in_family === 'KEPALA_KELUARGA' ? 'Simpan Perubahan' : 'Simpan Anggota Keluarga'}
                    </>
                  )}
                </button>
              </div>
