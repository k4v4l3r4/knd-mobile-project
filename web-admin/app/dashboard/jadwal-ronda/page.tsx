...
export default function JadwalRondaPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [schedRes, wargaRes, userRes] = await Promise.all([
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-xs text-slate-500 dark:text-slate-400">{formatPhoneNumber(member.user.phone)}</span>
                            </div>
                          </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-slate-500 dark:text-slate-400">{formatPhoneNumber(warga.phone)}</div>
                      </div>
                    </div>
