...
export const settingService = {
  ...
  updateWallet: (id: number, data: any) => api.post(`/settings/wallets/${id}`, data),
  ...
  updateActivity: (id: number, data: any) => api.post(`/settings/activities/${id}`, data),
  ...
  updateRole: (id: number, data: any) => api.post(`/settings/roles/${id}`, data),
  ...
  updateAdmin: (id: number, data: any) => api.post(`/settings/admins/${id}`, data),
