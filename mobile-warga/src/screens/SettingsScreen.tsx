...
const SettingsScreen = ({ onLogout, onNavigate }: SettingsScreenProps) => {
  ...
  const handleUpdateApp = () => {
    // Pastikan URL di bawah ini langsung menuju file .apk
    const apkDirectUrl = 'https://admin.afnet.my.id/download/app-latest.apk';
    Linking.openURL(apkDirectUrl);
  };
  ...
  const menuItems = [
    ...
    },
    {
      ...
      items: [
        { icon: 'cloud-download-outline', label: 'Update Aplikasi', onPress: handleUpdateApp },
