...
export default function PaymentScreen({ initialData, onSuccess, onBack }: { initialData?: any, onSuccess?: () => void, onBack?: () => void }) {
  ...
  const handleOpenDana = () => {
    ...
    // Format: https://link.dana.id/transfer?phoneNumber=...
