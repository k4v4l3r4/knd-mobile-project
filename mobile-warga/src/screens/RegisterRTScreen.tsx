          ...
          <View style={styles.formSection}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, styles.textAreaContainer, { backgroundColor: colors.card, borderColor: colors.border }]}>
                <Ionicons name="location-outline" size={20} color={colors.textSecondary} style={{ marginTop: 4 }} />
                <TextInput
                  style={[styles.inputField, styles.textAreaField, { color: colors.text }]}
            ...
            <View style={styles.inputGroup}>
                ...
                >
                  <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                    <Ionicons name="map-outline" size={20} color={colors.textSecondary} style={{ marginRight: 10 }} />
                    <Text
                      style={{
              ...
              <View style={styles.inputGroup}>
                <Text style={[styles.label, { color: colors.textSecondary }]}>
                  Kabupaten/Kota <Text style={{ color: '#ef4444' }}>*</Text>
                </Text>
                <TouchableOpacity
                  style={[
                    styles.inputContainer,
            ...
            <View style={styles.inputGroup}>
                ...
                >
                  <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                    <Ionicons name="navigate-outline" size={20} color={colors.textSecondary} style={{ marginRight: 10 }} />
                    <Text
                      style={{
              ...
              <View style={styles.inputGroup}>
                ...
                >
                  <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                    <Ionicons name="pin-outline" size={20} color={colors.textSecondary} style={{ marginRight: 10 }} />
                    <Text
                      style={{
          ...
          <View style={[styles.regionModalContent, { backgroundColor: colors.card }]}>
            <View style={styles.regionModalHeader}>
              <Text style={[styles.regionModalTitle, { color: colors.text }]}>
                ...
                {regionModalType === 'city' && 'Pilih Kabupaten/Kota'}
