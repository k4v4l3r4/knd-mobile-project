...
const HelpSupportScreen = ({ onNavigate }: { onNavigate: (screen: string) => void }) => {
  ...
  // Support Number (Centralized)
  const SUPPORT_PHONE = '628972498383';
  ...
  const sendToWhatsApp = () => {
    ...
    const phone = formatPhoneNumber(SUPPORT_PHONE);
    Linking.openURL(`https://wa.me/${phone}?text=${encodedText}`);
