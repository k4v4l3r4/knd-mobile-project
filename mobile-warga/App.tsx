...
const AppContent = () => {
  ...
  useEffect(() => {
    const backAction = () => {
      ...
      if (currentScreen === 'PRODUCT_DETAIL' || currentScreen === 'ADD_PRODUCT' || currentScreen === 'CART') {
  ...
  return (
    <ThemedContainer>
      ...
      {currentScreen === 'PAYMENT' && <PaymentScreen initialData={paymentData} onSuccess={() => setCurrentScreen('HOME')} onBack={() => setCurrentScreen('HOME')} />}
