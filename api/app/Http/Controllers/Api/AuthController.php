...
class AuthController extends Controller
{
    ...
    {
        Log::info("ForgotPassword request received", ['phone' => $request->phone, 'ip' => $request->ip()]);
        ...
        // Send via WhatsApp
          ...
          try {
              ...
              return response()->json([
                  'success' => false,
                  'message' => 'Gagal mengirim OTP ke WhatsApp (Gateway Error). Kode OTP Sementara: ' . $plainCode . '. Error: ' . $e->getMessage(),
              ], 500);
          }
